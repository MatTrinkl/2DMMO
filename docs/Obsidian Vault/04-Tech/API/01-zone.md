...
> Siehe [Chunk-Based Sync](../Architecture/CHUNK_BASED_SYNC.md) für Details zum Chunk-System.
> 
> **Dirty-Tracking System:**
> ZoneDelta nutzt das automatische Dirty-Tracking System für optimale Bandbreitennutzung.  
> Siehe [Dirty-Tracking Architecture](../Architecture/DIRTY_TRACKING.md) für vollständige Dokumentation.
...
Siehe [Dirty-Tracking Architecture](../Architecture/DIRTY_TRACKING.md) für vollständige Dokumentation und Beispiele.

### Verwandte Dokumentation

- [Dirty-Tracking System](../Architecture/DIRTY_TRACKING.md) - Automatisches Change-Tracking
- [Chunk-Based Sync System](../Architecture/CHUNK_BASED_SYNC.md) - Vollständige Dokumentation
- [Game Loop - Output Phase](../Architecture/GAME_LOOP.md) - Delta-Building Logik
...
Source: docs/03-messages/01-zone.md
