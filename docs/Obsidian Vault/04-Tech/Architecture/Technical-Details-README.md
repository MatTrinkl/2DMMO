...
- **System-Architektur**: Siehe [02-architecture/README.md](Architecture-Overview.md)
- **Gameplay-Design**: Siehe [01-overview/GAME_DESIGN_DOCUMENT.md](../../02-Game-Design/Systems/GAME_DESIGN_DOCUMENT.md)
- **Netzwerk-Protokoll**: Siehe [02-architecture/NETWORK_PROTOCOL.md](NETWORK_PROTOCOL.md)
...
**Navigation**: [← Zurück zur Hauptdokumentation](../../00-Home/Docs-Overview.md)

Source: docs/03-technical-details/README.md
