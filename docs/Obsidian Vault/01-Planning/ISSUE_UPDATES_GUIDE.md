...
### Architektur
- [ID-System](../04-Tech/Architecture/ID_SYSTEM.md) - Entity Identity, ZoneId Ranges
- [Architektur-Übersicht](../04-Tech/Architecture/Architecture-Overview.md) - System-Design
- [Server-Komponenten](../04-Tech/Architecture/SERVER_COMPONENTS.md) - Komponenten-Details
...
- [Feature-Roadmap](Roadmap/FEATURE_ROADMAP.md) - Geplante Features
...
**Navigation**: [← Zurück zur Projekt-Management-Übersicht](Project-Management-README.md)

Source: docs/04-project-management/ISSUE_UPDATES_GUIDE.md
