...
Diese Kategorie umfasst alle Messages für **inventory** Funktionalität im 2DMMO.

Inventory-Management, Item-Manipulation, Durability, Enchanting und Transmogrification.
