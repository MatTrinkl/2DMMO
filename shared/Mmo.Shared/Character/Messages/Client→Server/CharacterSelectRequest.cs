...
/// <summary>
///     This class sends the selected character from the character list. The server loads the character data and spawns the
///     character if everything is successfully.
///     Client -> Server
///     Ones per Session.
...
public class CharacterSelectRequest : IClientMessage
{
    /// <summary>
