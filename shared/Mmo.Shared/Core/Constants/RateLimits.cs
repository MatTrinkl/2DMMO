...
public static class RateLimits
{
    ...
    ///     Even if the Client is at a higher framerate (e.g. 60 FPS) the server is only ticking with
    ///     <see cref="SharedConstants.TickRate" />.
    ...
    ///     Normally each action (spell, attack, etc.) has a cooldown. But there are e.g. Instant Casts so the Limit needs to
    ///     be a bit higher.
    /// </summary>
